...
export const plCatalog: TranslationCatalog = {
    editor: {
        ...
        noSessionsYetCopy: 'Utwórz sesję, aby rozpocząć.',
    ...
    library: {
        ...
        noSessionsYetGetStarted: 'Brak sesji. Utwórz jedną, aby zacząć!',
    ...
    overlay: {
        ...
        dimLevelAria: ({ level }) => `Poziom przyciemnienia: ${level}`,
    ...
    settingsView: {
        ...
        shortcuts: {
            ...
            togglePrompter: 'Przełącz prompter',
