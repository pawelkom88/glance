...
export const plCatalog: TranslationCatalog = {
    ...
    help: {
        ...
        shortcutSnapToCenter: 'Przypnij do gory',
    ...
    overlay: {
        ...
        jump: 'Menu sekcji',
        reset: 'Resetuj',
        snapToCentre: 'Przypnij do gory',
        lockWindowPosition: 'Zablokuj pozycje okna',
        unlockWindowPosition: 'Odblokuj pozycje okna',
        snapError: 'Nie udalo sie ustawic nakladki u gory ekranu.',
